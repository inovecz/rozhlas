<template>
  <div class="px-5 py-5">
    ...
    <div class="content">
      <button id="record" @click="startStream" class="py-4 px-5 text-2xl text-gray-50 bg-green-500 hover:bg-green-600 border border-green-700 w-full rounded tracking-wide">Zahájit vysílání</button>
