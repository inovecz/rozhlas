...
const sourceToMixerInputMap = {
  ...
  pc_webrtc: 'system',
  system_audio: 'system',
  jsvv_remote_voice: 'jsvv_remote_voice',
  jsvv_local_voice: 'jsvv_local_voice',
  jsvv_external_primary: 'jsvv_external_primary',
  jsvv_external_secondary: 'jsvv_external_secondary',
  fm_radio: 'fm',
